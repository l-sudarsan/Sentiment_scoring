# -*- coding: utf-8 -*-
"""
Created on Mon Apr  8 14:08:17 2019
...
#    Get number of reviews and start getting subpages with reviews
    ...
    num_reviews = soup.find('span', class_='reviewCount').text # get text #use reviews_header_count
...
def parse_reviews(session, url):
    ...
    hotel_name = soup.find('h1', id='HEADING')
...
start_urls = [
#        'https://www.tripadvisor.in/Restaurant_Review-g297628-d1389538-Reviews-Time_Traveller-Bengaluru_Bangalore_District_Karnataka.html'
        'https://www.tripadvisor.in/Hotel_Review-g297628-d8587934-Reviews-Shangri_La_Hotel_Bengaluru-Bengaluru_Bangalore_District_Karnataka.html',
...
blob = TextBlob(df['review_body'].str())
